...
export const LIGHT_COLORS: CssVariables = {
...
export const DARK_COLORS: CssVariables = {
...
export const LIGHT_SHADOWS: CssVariables = {
  "--shadow-page": `
...
export const DARK_SHADOWS: CssVariables = {
  "--shadow-page": "none",
  "--shadow-card": "none",
};

export const LIGHT_TOKENS: CssVariables = {
  ...LIGHT_COLORS,
  ...LIGHT_SHADOWS,
};

export const DARK_TOKENS: CssVariables = {
  ...DARK_COLORS,
  ...DARK_SHADOWS,
};
